...
- Add pause / resume feature TODO
  ...
  - clear save game data once that game is completed - if isRestarted && isGameOver - and remove save game message from login screen DONE
  - BUG not showing previous message correctly
